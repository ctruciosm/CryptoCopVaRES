...
write.table(data.frame(VaR),"VaRGASCVine2.txt",sep=",",dec=".",col.names=FALSE,row.names = FALSE)
write.table(data.frame(ES),"ESGASCVine2.txt",sep=",",dec=".",col.names=FALSE,row.names = FALSE)
